...
static struct tegra12_emc_table jetson_tk1_ddr3_embedded_emc_table[] = {
	{
		0x19,       /* V5.0.18 */
		"01_204000_01_V5.0.18_V1.1", /* DVFS table version */
		204000,     /* SDRAM frequency */
		1050,        /* min voltage */
		1050,        /* gpu min voltage */
		"pllp_out0", /* clock source id */
		0x40000002, /* CLK_SOURCE_EMC */
		165,        /* number of burst_regs */
		31,         /* number of up_down_regs */
		{
			...
			0x00000000, /* EMC_DLL_XFORM_ADDR3 */
			0x00000000, /* EMC_DLL_XFORM_ADDR4 */
			0x00018000, /* EMC_DLL_XFORM_ADDR5 */
			0x00000000, /* EMC_DLL_XFORM_QUSE8 */
			0x00000000, /* EMC_DLL_XFORM_QUSE9 */
			0x00000000, /* EMC_DLL_XFORM_QUSE10 */
			0x00000000, /* EMC_DLL_XFORM_QUSE11 */
	...
	{
		0x19,       /* V5.0.18 */
		"01_600000_01_V5.0.18_V1.1", /* DVFS table version */
		600000,     /* SDRAM frequency */
		1050,        /* min voltage */
		1050,        /* gpu min voltage */
		"pllc_ud",  /* clock source id */
	...
	{
		0x19,       /* V5.0.18 */
		"01_792000_01_V5.0.18_V1.1", /* DVFS table version */
		792000,     /* SDRAM frequency */
		1050,        /* min voltage */
		1050,        /* gpu min voltage */
		"pllm_ud",  /* clock source id */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00000006, /* EMC_DLI_TRIM_TXDQS6 */
			0x00000007, /* EMC_DLI_TRIM_TXDQS7 */
			0x00000006, /* EMC_DLI_TRIM_TXDQS8 */
	...
	{
		0x19,       /* V5.0.18 */
		"01_924000_01_V5.0.18_V1.1", /* DVFS table version */
		924000,     /* SDRAM frequency */
		1100,       /* min voltage */
		1100,       /* gpu min voltage */
		"pllm_ud",  /* clock source id */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00000000, /* EMC_XM2VTTGENPADCTRL2 */
			0x016eeeee, /* EMC_XM2VTTGENPADCTRL3 */
			0x5d755520, /* EMC_XM2DQSPADCTRL3 */
			0x00514514, /* EMC_XM2DQSPADCTRL4 */
			0x00514514, /* EMC_XM2DQSPADCTRL5 */
			0x5d555500, /* EMC_XM2DQSPADCTRL6 */
			0x0606003f, /* EMC_DSR_VTTGEN_DRV */
			0x00000000, /* EMC_TXDSRVTTGEN */
			0x00000000, /* EMC_FBIO_SPARE */
			0x00020000, /* EMC_ZCAL_INTERVAL */
...
static struct tegra12_emc_table jetson_tk1_ddr3_4GB_emc_table[] = {

	{
		0x19,	    /* V6.0.3 */
		"01_12750_NoCfgVersion_V6.0.3_V1.1", /* DVFS table version */
		12750,	    /* SDRAM frequency */
		800,	    /* min voltage */
		800,	    /* gpu min voltage */
		"pllp_out0", /* clock source id */
		...
		31,	    /* number of up_down_regs */
		{
			...
			0x00000000, /* EMC_DLL_XFORM_ADDR0 */
			0x00000000, /* EMC_DLL_XFORM_ADDR1 */
			0x00028000, /* EMC_DLL_XFORM_ADDR2 */
			0x00000000, /* EMC_DLL_XFORM_ADDR3 */
			0x00000000, /* EMC_DLL_XFORM_ADDR4 */
			0x00028000, /* EMC_DLL_XFORM_ADDR5 */
			0x00000000, /* EMC_DLL_XFORM_QUSE8 */
			0x00000000, /* EMC_DLL_XFORM_QUSE9 */
			0x00000000, /* EMC_DLL_XFORM_QUSE10 */
			0x00000000, /* EMC_DLL_XFORM_QUSE11 */
	...
	{
		0x19,	    /* V6.0.3 */
		"01_20400_NoCfgVersion_V6.0.3_V1.1", /* DVFS table version */
		20400,	    /* SDRAM frequency */
		800,	    /* min voltage */
		800,	    /* gpu min voltage */
		"pllp_out0", /* clock source id */
	...
	{
		0x19,	    /* V6.0.3 */
		"01_40800_NoCfgVersion_V6.0.3_V1.1", /* DVFS table version */
		40800,	    /* SDRAM frequency */
		800,	    /* min voltage */
		800,	    /* gpu min voltage */
		"pllp_out0", /* clock source id */
	...
	{
		0x19,	    /* V6.0.3 */
		"01_68000_NoCfgVersion_V6.0.3_V1.1", /* DVFS table version */
		68000,	    /* SDRAM frequency */
		800,	    /* min voltage */
		800,	    /* gpu min voltage */
		"pllp_out0", /* clock source id */
	...
	{
		0x19,	    /* V6.0.3 */
		"01_102000_NoCfgVersion_V6.0.3_V1.1", /* DVFS table version */
		102000,     /* SDRAM frequency */
		800,	    /* min voltage */
		800,	    /* gpu min voltage */
		"pllp_out0", /* clock source id */
	...
	{
		0x19,	    /* V6.0.3 */
		"01_204000_NoCfgVersion_V6.0.3_V1.1", /* DVFS table version */
		204000,     /* SDRAM frequency */
		800,	    /* min voltage */
		800,	    /* gpu min voltage */
		"pllp_out0", /* clock source id */
	...
	{
		0x19,	    /* V6.0.3 */
		"01_300000_NoCfgVersion_V6.0.3_V1.1", /* DVFS table version */
		300000,     /* SDRAM frequency */
		820,	    /* min voltage */
		820,	    /* gpu min voltage */
		"pllc_out0", /* clock source id */
		...
		31,	    /* number of up_down_regs */
		{
			...
			0x00084000, /* EMC_DLL_XFORM_ADDR1 */
			0x00010000, /* EMC_DLL_XFORM_ADDR2 */
			0x00084000, /* EMC_DLL_XFORM_ADDR3 */
			0x00084000, /* EMC_DLL_XFORM_ADDR4 */
		...
		0x00000321, /* Mode Register 0 */
		0x00100002, /* Mode Register 1 */
		0x00200400, /* Mode Register 2 */
		0x00000000, /* Mode Register 4 */
		2680,	    /* expected dvfs latency (ns) */
	},
	{
		0x19,	    /* V6.0.3 */
		"01_396000_NoCfgVersion_V6.0.3_V1.1", /* DVFS table version */
		396000,     /* SDRAM frequency */
		850,	    /* min voltage */
		850,	    /* gpu min voltage */
		"pllm_out0", /* clock source id */
		...
		31,	    /* number of up_down_regs */
		{
			...
			0x00000000, /* EMC_DLL_XFORM_QUSE6 */
			0x00000000, /* EMC_DLL_XFORM_QUSE7 */
			0x0005c000, /* EMC_DLL_XFORM_ADDR0 */
			0x0005c000, /* EMC_DLL_XFORM_ADDR1 */
			0x00010000, /* EMC_DLL_XFORM_ADDR2 */
			0x0005c000, /* EMC_DLL_XFORM_ADDR3 */
			0x0005c000, /* EMC_DLL_XFORM_ADDR4 */
			0x00010000, /* EMC_DLL_XFORM_ADDR5 */
			0x00000000, /* EMC_DLL_XFORM_QUSE8 */
			0x00000000, /* EMC_DLL_XFORM_QUSE9 */
			0x00000000, /* EMC_DLL_XFORM_QUSE10 */
	...
	{
		0x19,	    /* V6.0.3 */
		"01_528000_NoCfgVersion_V6.0.3_V1.1", /* DVFS table version */
		528000,     /* SDRAM frequency */
		880,	    /* min voltage */
		870,	    /* gpu min voltage */
		"pllm_ud",  /* clock source id */
		...
		31,	    /* number of up_down_regs */
		{
			...
			0x00040000, /* EMC_DLL_XFORM_ADDR0 */
			0x00040000, /* EMC_DLL_XFORM_ADDR1 */
			0x00000002, /* EMC_DLL_XFORM_ADDR2 */
			0x00040000, /* EMC_DLL_XFORM_ADDR3 */
			0x00040000, /* EMC_DLL_XFORM_ADDR4 */
			0x00000002, /* EMC_DLL_XFORM_ADDR5 */
			0x00000000, /* EMC_DLL_XFORM_QUSE8 */
			0x00000000, /* EMC_DLL_XFORM_QUSE9 */
			0x00000000, /* EMC_DLL_XFORM_QUSE10 */
			0x00000000, /* EMC_DLL_XFORM_QUSE11 */
			...
			0x00000003, /* EMC_DLI_TRIM_TXDQS4 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS5 */
			...
			0x00000003, /* EMC_DLI_TRIM_TXDQS12 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS13 */
			0x00000002, /* EMC_DLI_TRIM_TXDQS14 */
			0x00000003, /* EMC_DLI_TRIM_TXDQS15 */
			0x0000000e, /* EMC_DLL_XFORM_DQ0 */
			0x0000000e, /* EMC_DLL_XFORM_DQ1 */
			0x0000000e, /* EMC_DLL_XFORM_DQ2 */
		...
		0x00000941, /* Mode Register 0 */
		0x00100002, /* Mode Register 1 */
		0x00200408, /* Mode Register 2 */
		0x00000000, /* Mode Register 4 */
		1440,	    /* expected dvfs latency (ns) */
	},
	{
		0x19,	    /* V6.0.3 */
		"01_600000_NoCfgVersion_V6.0.3_V1.1", /* DVFS table version */
		600000,     /* SDRAM frequency */
		910,	    /* min voltage */
		910,	    /* gpu min voltage */
		"pllc_ud",  /* clock source id */
		...
		31,	    /* number of up_down_regs */
		{
			...
			0x00034000, /* EMC_DLL_XFORM_ADDR0 */
			0x00034000, /* EMC_DLL_XFORM_ADDR1 */
			0x00004002, /* EMC_DLL_XFORM_ADDR2 */
			0x00034000, /* EMC_DLL_XFORM_ADDR3 */
			0x00034000, /* EMC_DLL_XFORM_ADDR4 */
			0x00004002, /* EMC_DLL_XFORM_ADDR5 */
			0x00000000, /* EMC_DLL_XFORM_QUSE8 */
			0x00000000, /* EMC_DLL_XFORM_QUSE9 */
			0x00000000, /* EMC_DLL_XFORM_QUSE10 */
			0x00000000, /* EMC_DLL_XFORM_QUSE11 */
			...
			0x00000004, /* EMC_DLI_TRIM_TXDQS1 */
			0x00000001, /* EMC_DLI_TRIM_TXDQS2 */
			0x00000004, /* EMC_DLI_TRIM_TXDQS3 */
			0x00000005, /* EMC_DLI_TRIM_TXDQS4 */
			...
			0x00000004, /* EMC_DLI_TRIM_TXDQS9 */
			0x00000001, /* EMC_DLI_TRIM_TXDQS10 */
			0x00000004, /* EMC_DLI_TRIM_TXDQS11 */
			0x00000005, /* EMC_DLI_TRIM_TXDQS12 */
		...
		0x00000b61, /* Mode Register 0 */
		0x00100002, /* Mode Register 1 */
		0x00200410, /* Mode Register 2 */
		0x00000000, /* Mode Register 4 */
		1440,	    /* expected dvfs latency (ns) */
	},
	{
		0x19,	    /* V6.0.3 */
		"01_792000_NoCfgVersion_V6.0.3_V1.1", /* DVFS table version */
		792000,     /* SDRAM frequency */
		980,	    /* min voltage */
		980,	    /* gpu min voltage */
		"pllm_ud",  /* clock source id */
		...
		31,	    /* number of up_down_regs */
		{
			...
			0x00020000, /* EMC_DLL_XFORM_ADDR1 */
			0x00000004, /* EMC_DLL_XFORM_ADDR2 */
			0x00020000, /* EMC_DLL_XFORM_ADDR3 */
			0x00020000, /* EMC_DLL_XFORM_ADDR4 */
			0x00000004, /* EMC_DLL_XFORM_ADDR5 */
			0x00000000, /* EMC_DLL_XFORM_QUSE8 */
			0x00000000, /* EMC_DLL_XFORM_QUSE9 */
			0x00000000, /* EMC_DLL_XFORM_QUSE10 */
			0x00000000, /* EMC_DLL_XFORM_QUSE11 */
			...
			0x00000005, /* EMC_DLI_TRIM_TXDQS2 */
			0x00000008, /* EMC_DLI_TRIM_TXDQS3 */
			0x00000008, /* EMC_DLI_TRIM_TXDQS4 */
			0x00000005, /* EMC_DLI_TRIM_TXDQS5 */
			0x00000008, /* EMC_DLI_TRIM_TXDQS6 */
			0x00000009, /* EMC_DLI_TRIM_TXDQS7 */
			0x00000007, /* EMC_DLI_TRIM_TXDQS8 */
			0x00000008, /* EMC_DLI_TRIM_TXDQS9 */
			0x00000005, /* EMC_DLI_TRIM_TXDQS10 */
			0x00000008, /* EMC_DLI_TRIM_TXDQS11 */
			0x00000008, /* EMC_DLI_TRIM_TXDQS12 */
			0x00000005, /* EMC_DLI_TRIM_TXDQS13 */
			0x00000008, /* EMC_DLI_TRIM_TXDQS14 */
			0x00000009, /* EMC_DLI_TRIM_TXDQS15 */
			0x0000000b, /* EMC_DLL_XFORM_DQ0 */
			0x0000000b, /* EMC_DLL_XFORM_DQ1 */
			0x0000000b, /* EMC_DLL_XFORM_DQ2 */
			0x0000000b, /* EMC_DLL_XFORM_DQ3 */
			...
			0x00000000, /* EMC_XM2VTTGENPADCTRL2 */
			0x016eeeee, /* EMC_XM2VTTGENPADCTRL3 */
			0x5135d520, /* EMC_XM2DQSPADCTRL3 */
			0x00596596, /* EMC_XM2DQSPADCTRL4 */
			0x00596596, /* EMC_XM2DQSPADCTRL5 */
			0x55451500, /* EMC_XM2DQSPADCTRL6 */
			0x0606003f, /* EMC_DSR_VTTGEN_DRV */
			0x00000000, /* EMC_TXDSRVTTGEN */
			0x00000000, /* EMC_FBIO_SPARE */
			0x00020000, /* EMC_ZCAL_INTERVAL */
		...
		0xe0070069, /* EMC_CFG_DIG_DLL */
		0x00000000, /* EMC_BGBIAS_CTL0 */
		0x00000404, /* EMC_AUTO_CAL_CONFIG2 */
		0x00000404, /* EMC_AUTO_CAL_CONFIG3 */
		0xa1430f0f, /* EMC_AUTO_CAL_CONFIG */
		0x00000d71, /* Mode Register 0 */
		0x00100002, /* Mode Register 1 */
		0x00200418, /* Mode Register 2 */
		0x00000000, /* Mode Register 4 */
		1200,	    /* expected dvfs latency (ns) */
	},
	{
		0x19,	    /* V6.0.3 */
		"01_924000_NoCfgVersion_V6.0.3_V1.1", /* DVFS table version */
		924000,     /* SDRAM frequency */
		1010,	    /* min voltage */
		1010,	    /* gpu min voltage */
		"pllm_ud",  /* clock source id */
		...
		31,	    /* number of up_down_regs */
		{
			...
			0x00018000, /* EMC_DLL_XFORM_ADDR1 */
			0x00000005, /* EMC_DLL_XFORM_ADDR2 */
			0x00018000, /* EMC_DLL_XFORM_ADDR3 */
			0x00018000, /* EMC_DLL_XFORM_ADDR4 */
			0x00000005, /* EMC_DLL_XFORM_ADDR5 */
			0x00000000, /* EMC_DLL_XFORM_QUSE8 */
			0x00000000, /* EMC_DLL_XFORM_QUSE9 */
			0x00000000, /* EMC_DLL_XFORM_QUSE10 */
			0x00000000, /* EMC_DLL_XFORM_QUSE11 */
			...
			0x00000009, /* EMC_DLI_TRIM_TXDQS1 */
			0x00000006, /* EMC_DLI_TRIM_TXDQS2 */
			...
			0x00000009, /* EMC_DLI_TRIM_TXDQS9 */
			0x00000006, /* EMC_DLI_TRIM_TXDQS10 */
			...
			0x00020000, /* EMC_ZCAL_INTERVAL */
			0x00000128, /* EMC_ZCAL_WAIT_CNT */
			0x002f000e, /* EMC_MRS_WAIT_CNT */
			0x002f000e, /* EMC_MRS_WAIT_CNT2 */
			0x00000000, /* EMC_CTT */
			0x00000004, /* EMC_CTT_DURATION */
			0x00004080, /* EMC_CFG_PIPE */
			0x800037ea, /* EMC_DYN_SELF_REF_CONTROL */
		...
		0x00000000, /* EMC_AUTO_CAL_CONFIG3 */
		0xa1430000, /* EMC_AUTO_CAL_CONFIG */
		0x00000f15, /* Mode Register 0 */
		0x00100002, /* Mode Register 1 */
		0x00200420, /* Mode Register 2 */
		0x00000000, /* Mode Register 4 */
		1180,	    /* expected dvfs latency (ns) */
	},
};

static struct tegra12_emc_table pm375_ddr3_emc_table[] = {
	{
		0x19,       /* V5.0.14 */
...
static struct tegra12_emc_pdata jetson_tk1_2GB_emc_pdata = {
	.description = "ardbeg_emc_tables",
	.tables = jetson_tk1_ddr3_emc_table,
	.num_tables = ARRAY_SIZE(jetson_tk1_ddr3_emc_table),
};

static struct tegra12_emc_pdata jetson_tk1_2GB_embedded_emc_pdata = {
	.description = "ardbeg_emc_tables",
	.tables = jetson_tk1_ddr3_embedded_emc_table,
	.num_tables = ARRAY_SIZE(jetson_tk1_ddr3_embedded_emc_table),
};

static struct tegra12_emc_pdata jetson_tk1_4GB_emc_pdata = {
	.description = "ardbeg_emc_tables",
	.tables = jetson_tk1_ddr3_4GB_emc_table,
	.num_tables = ARRAY_SIZE(jetson_tk1_ddr3_4GB_emc_table),
};

static struct tegra12_emc_pdata pm375_2GB_emc_pdata = {
	.description = "ardbeg_emc_tables",
		...
		case BOARD_PM375:
			if (of_machine_is_compatible("nvidia,jetson-tk1")) {
				if (tegra_get_memory_type() == 1) {
					...
					if (soc_speedo_id == 4) {
						pr_info("Loading jetson TK1 EMC Embedded tables.\n");
						tegra_emc_device.dev.platform_data =
							&jetson_tk1_2GB_embedded_emc_pdata;
					} else {
